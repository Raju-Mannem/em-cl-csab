...
// interface csabCutoff2025sPdfData {
//   sno: number;
//   institute: string;
//   academicProgramName: string;
// }

interface csab2025ByRankQueryResult {
  csab2025ByRank: CutoffRow[];
}
...
const Cutoff2024 = () => {
  ...
  const [fetchCutoffs, { data, loading, error }] =
    useLazyQuery<csab2025ByRankQueryResult>(GET_CSAB_2025, {
      errorPolicy: "all",
    });
  ...
  useEffect(() => {
    if (data?.csab2025ByRank) {
      setResult(data.csab2025ByRank);
    }
  }, [data]);
